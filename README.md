...
#### 2.变量AGENT_VER，可选，指定哪吒客户端版本，不填则默认v0.17.5

#### 3.变量DASH_VER，可选，指定哪吒服务端版本,不填则默认v0.17.9

#### 4.本地哪吒名称要以Local开头，如果碰到本地不亮，可以设置变量NO_SUIJI值为任意哪吒key,然后进入哪吒面板控制台设置本地的哪吒key为前面设置的哪吒key即可
